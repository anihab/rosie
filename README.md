...
You can invite Rosie to your server with this [invite URL](https://discord.com/oauth2/authorize?client_id=1306658573945667585&scope=bot%20applications.commands&permissions=342207552)!
...
_Data Deletion:_ This data is automatically deleted when reminders and events expire, are canceled, or finalized. For reaction role messages, the associated data is deleted when the message itself is removed or when the server administrator manually runs a command to clear the database.
...
_Data Deletion:_ This data is automatically deleted when the associated reminders and events expire, are canceled, or finalized.
...
By continuing to use Rosie, you acknowledge and agree to these terms. If you do not agree, you should discontinue using Rosie immediately.

For any concerns or data removal requests, please contact the bot owner.